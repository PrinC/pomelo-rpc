...
var Client = function(opts) {
  ...
  // sequenceMap for at most once rpc semantic
  this.sequenceMap = {};
};
...
pro.rpcInvoke = function(serverId, msg, cb) {
  ...
  // at most once rpc semantic patch here
  if (this.sequenceMap[serverId] == undefined)
    this.sequenceMap[serverId] = 0;
  msg.seq = this.sequenceMap[serverId];
  this.sequenceMap[serverId] ++;
